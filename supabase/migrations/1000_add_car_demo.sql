-- Add demo car configuration to CPQ system
-- Car: Sedan Economy with customizable engine, equipment, color, wheels, and safety features

-- Use the test tenant ID (same as Gaming PC sample data)
