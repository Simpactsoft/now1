...
-- Migration: 241_fix_org_rpc.sql
-- Description: Fixes "cannot change return type" error by dropping functions first.

-- 1. DROP existing functions (Order matters due to dependencies)
...
-- 2. Re-create fetch_organizations_data with new columns
...
-- 3. Re-create Wrapper Function fetch_organizations_crm
