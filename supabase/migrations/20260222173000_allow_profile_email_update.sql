-- Migration: Allow Profile Email Update
-- Description: Updates the 'update_portal_profile' RPC to accept and persist an 'arg_email' parameter.
...
BEGIN
    ...
    IF v_card_id IS NOT NULL THEN
        ...
        SET 
            ...
            email = coalesce(arg_email, email), -- Update legacy email column if provided
