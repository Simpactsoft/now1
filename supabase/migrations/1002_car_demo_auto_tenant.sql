-- Clean up any existing Sedan Economy templates and create fresh with auto-detected tenant
-- This version automatically uses your current organization's tenant_id

-- First, clean up any existing Sedan Economy templates from ANY tenant
DELETE FROM product_templates WHERE name = 'Sedan Economy';

-- Get tenant_id from an existing product template
...
SELECT 
    (SELECT tenant_id FROM car_template) as used_tenant_id,
