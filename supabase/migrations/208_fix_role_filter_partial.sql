...
-- Migration: 208_fix_role_filter_partial.sql
-- Description: Updates fetch_people RPCs to use ILIKE (Partial Match) for Role filtering.
...
BEGIN
    ...
    -- Role (Partial Match - Fixed)
    -- Logic: Matches if ANY role contains the filter string (ILIKE)
