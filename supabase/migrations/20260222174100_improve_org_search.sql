-- Migration: Improve Organization Search
-- Description: Updates fetch_organizations_data and get_organizations_count to search across display_name and email.
...
-- 2. Define fetch_organizations_data
