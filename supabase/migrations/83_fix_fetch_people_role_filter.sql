-- Fix Role Filter to be Case-Insensitive and Trim whitespace
-- This ensures 'ceo' matches 'CEO' and solves Hebrew matching issues if any encoding diffs occurred (though rare)
...
BEGIN
    ...
    -- Role (Case Insensitive & Trimmed + Custom Fields Fallback)
