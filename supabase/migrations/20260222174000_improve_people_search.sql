-- Migration: Improve People Search
-- Description: Updates fetch_people_data and get_people_count to search across display_name, first_name, last_name, and email.
