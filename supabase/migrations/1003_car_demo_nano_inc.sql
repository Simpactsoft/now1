-- Clean up and create car demo with Nano Inc's tenant_id
-- This version uses the correct tenant_id for your "Nano Inc" organization
...
-- Use Nano Inc's specific tenant_id
